...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-cms/security/advisories/new).
...
In scope: anything in `semitexa/cms` that lets a request, a job or a message do
